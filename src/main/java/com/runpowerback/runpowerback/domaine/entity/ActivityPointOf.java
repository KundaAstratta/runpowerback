...
public class ActivityPointOf {
    ...
    public ActivityPointOf() {}

    public ActivityPointOf(Long id,  float latitude, float longitude, float elevation, float hearthrate, String timezone) {
        this.id = id;
