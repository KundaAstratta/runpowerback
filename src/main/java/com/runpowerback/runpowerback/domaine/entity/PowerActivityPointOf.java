...
public class PowerActivityPointOf {
    @Id
    ...
    public PowerActivityPointOf() {}

    public PowerActivityPointOf(Long id, Long idathlete, Long idpoweractivity, float power, float speed, float hearthrate, float distance, float pace, float timezone, String date, String time) {
        this.id = id;
    ...
    public PowerActivityPointOf(Long id, Long idathlete, Long idpoweractivity, float power, float speed, float hearthrate, float distance, float pace, float timezone) {
        this.id = id;
        this.idathlete = idathlete;
        this.idpoweractivity = idpoweractivity;
        this.power = power;
